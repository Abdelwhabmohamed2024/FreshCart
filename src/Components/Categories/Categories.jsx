    ...
    <>
      <section className="py-5">
        <div className="container">
          <h3 className="h4 text-main text-center fw-bold mb-4">Categories</h3>
          {loading ? (
            <div className="container">
            ...
            <div className="row gy-3">
              {category.map((category) => (
                <div key={category?._id} className={`col-md-4 ${style.screenSm}`}>
                  <div className="imagePhoto text-center">
